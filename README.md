...
本仓库是《圣墓王座》的**唯一设定、正文与连续性事实来源**。后续不以聊天记录或离线压缩包作为最终依据。

## 协作角色

- 用户：读者与方向裁决者
- ChatGPT：作者，负责编写、修订和设定回写
- Codex：证据型 Reviewer，负责发现漏洞与连续性问题
...
- `bible/16_ARTIFACT_SYSTEM.md`：宝物体系
